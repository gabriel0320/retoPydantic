...
categorias = {
    ...
    "feliz": {
        "palabras_claves": ["me siento feliz", "estoy muy contento", "estoy alegre", "me siento de maravilla", "todo va bien"],
    ...
    "triste":{
        "palabras_claves": ["me siento triste", "estoy deprimido", "no me siento bien", "me siento desanimado", "estoy muy mal"],
     ...
     "enojado":{
        "palabras_claves": ["estoy enojado", "me siento furioso", "estoy muy molesto", "tengo mucha rabia", "me siento frustrado"],
    ...
    "ansioso":{
        "palabras_claves": ["me siento ansioso", "estoy nervioso", "tengo mucha ansiedad", "me siento inquieto", "estoy preocupado"],
    ...
    "estresado":{
        "palabras_claves": ["me siento estresado", "estoy bajo mucho estrés", "tengo mucho estrés", "me siento abrumado", "estoy muy estresado"],
